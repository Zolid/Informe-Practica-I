...
\begin{anexo}
	\section{Anexos}
		...
		\insertimageboxed{practica/akori}{scale=0.48}{Interfaz de la Plataforma del \textit{Proyecto AKORI}.}
		\insertimageboxed{practica/reporte}{scale=0.48}{Análisis del sitio web de \textit{GOOGLE}.}
		\insertimageboxed{practica/cargando}{scale=0.48}{Procesamiento de información.}
		\insertimageboxed{practica/mapas}{scale=0.48}{Mapas desplegados.}
		\insertimageboxed{practica/objmap}{scale=0.48}{Acercamiento del Mapa de Objetos Claves.}
		\insertimageboxed{practica/rojo}{scale=0.48}{Mapa de Objetos Claves en escala de rojo.}
		\insertimageboxed{practica/azul}{scale=0.48}{Mapa de Objetos Claves en escala de azul.}
		\insertimageboxed{practica/verde}{scale=0.48}{Mapa de Objetos Claves en escala de verde.}
		\insertimageboxed{practica/naranjo}{scale=0.48}{Mapa de Objetos Claves en escala de naranjo.}
