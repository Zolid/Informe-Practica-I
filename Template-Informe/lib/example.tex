...
\end{lstlisting}
	...
	\textit{ArrayList}, para luego a entrar a un ciclo donde se dibujaba un rectángulo (que 				encerraba al objeto web) de acuerdo a la posición y las dimensiones de cada objeto web sobre una 
