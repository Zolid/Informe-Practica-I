...
\section{Trabajo Realizado}
	...
	\subsection{Etapa 0}
        ...
        no contaba con una clase propia dentro del código de la aplicación. Realizando una 	
        explicación más detallada del código de la subsección \ref{subseccion141} 
        (ver código \ref{version-java})}
...
def objmapColor(screenshot, path, matrix, color_string):
    ...
    return output
\end{lstlisting}
\newpar{El resto del algoritmo de construcción del mapa de objetos es análogo a los explicado
en la subsección anterior por lo que la omitimos.}
