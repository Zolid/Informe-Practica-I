...
\end{lstlisting}
	...
	\subsection{Descripción general del trabajo realizado} 
		...
		\textit{HTML}, luego se ideó un mapa de objetos que diferencia los elementos más 
		...
		describen brevemente a continuación:
			\begin{enumerate}
				...
				\item \textbf{Etapa de FrontEnd}: Una vez listos las funciones y algoritmos de 
...
posiciones de objetos web (ver figura \ref{escaladecolores}), para ello se gráficaba la matriz gracias a la función 
...
como la de la figura \ref{mapadecolores}, dicho procedimiento se llevaba a cabo con la función \textit{objmapColor}.}
