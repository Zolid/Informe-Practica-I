...
\subsection{Equipos y Software}	
	...
	\subsection{Situación Previa}
		...
		funcionamiento.} 
		\subsubsection{Versión \textit{Java} con \textit{Servlet}}
			...
			\begin{lstlisting}[style=Java, caption={Código mapa de objetos versión 1.\label{codigo-java}}]
	...
	\subsection{Descripción general del trabajo realizado} 
		...
		describen brevemente a continuación:
			\begin{enumerate}
				...
				en agregar el mapa de objetos en la una tecnología desconocida por el 
				practicante, fue necesario estudiar el framework tanto su sintaxis como 
				su filosofía de programación, para luego comenzar a explorar el código 
				existente dentro de la aplicación de forma de identificar aquellas clases 
				y funciones claves involucradas a la partes a extender.
				\item \textbf{Migración del código}:
				\item \textbf{Etapa de FontEnd}:
			\end{enumerate}
